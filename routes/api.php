...
Route::middleware('auth:sanctum')->group(function () {
    ...
    // ── Asatidz Management ──
    Route::middleware('permission:manage_asatidz,sanctum')->group(function () {
    ...
    // ── Meetings Management ──
    Route::middleware('permission:manage_meetings,sanctum')->group(function () {
    ...
    // ── Reports ──
    Route::middleware('permission:view_reports,sanctum')->group(function () {
    ...
    Route::middleware('permission:manage_approvals,sanctum')->group(function () {
    ...
    Route::middleware('permission:manage_users,sanctum')->group(function () {
    ...
    Route::middleware('permission:manage_master_data,sanctum')->group(function () {
    ...
    Route::middleware('permission:manage_settings,sanctum')->group(function () {
